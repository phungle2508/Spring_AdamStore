...
@Getter
@AllArgsConstructor
public enum DistrictDongNaiEnum {
    ...
    public District toDistrict() {
        return District.builder()
                .name(this.name)
                .province(ProvinceEnum.DONG_NAI.toProvince())
                .build();
    }

    public static List<District> getAllDistricts() {
        return Arrays.stream(DistrictDongNaiEnum.values())
                .map(DistrictDongNaiEnum::toDistrict)
