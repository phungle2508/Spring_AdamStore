...
@Getter
@AllArgsConstructor
public enum DistrictTayNinhEnum {
    ...
    public District toDistrict() {
        return District.builder()
                .name(this.name)
                .province(ProvinceEnum.TAY_NINH.toProvince())
                .build();
    }

    public static List<District> getAllDistricts() {
        return Arrays.stream(DistrictTayNinhEnum.values())
                .map(DistrictTayNinhEnum::toDistrict)
